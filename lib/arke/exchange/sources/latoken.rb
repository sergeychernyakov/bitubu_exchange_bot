...
module Arke::Exchange::Sources
  class Binance < Base
    ...
    def initialize(opts)
      ...
      # https://latoken.com/
      # https://api.latoken.com/v2
      # wss://api.latoken.com/stomp
      # /v1/book/{base}/{quote}
      @url = "wss://api.latoken.com/stomp/#{base_currency}/#{quote_currency}
      # {@market.downcase}@depth@100ms"
      @connection = Faraday.new("https://latoken.com") do |builder|
        builder.adapter :em_synchrony
      end

      @conn2 = Faraday.new('https://latoken.com/')
